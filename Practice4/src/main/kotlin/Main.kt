   ...
   //Zd 1
    ...
    fun main() {
        val myFirstName = "Кемран"
        val myLastName = "Гошоков"
        printFullName(firstName = "Kemran", lastName = "Goshokov")
        ...
        val fullName = calculateFullName("Кемран", "Гошоков")
        println(fullName)
        ...
        val result = calculateFullName1("Кемран", "Гошоков")
